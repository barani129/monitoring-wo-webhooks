...
func (in *MetallbScanCondition) DeepCopy() *MetallbScanCondition {
	if in == nil {
		return nil
	}
	out := new(MetallbScanCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MetallbScanSpec) DeepCopyInto(out *MetallbScanSpec) {
	*out = *in
	...
	if in.SpeakerPodLabel != nil {
		in, out := &in.SpeakerPodLabel, &out.SpeakerPodLabel
		*out = new(map[string]string)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]string, len(*in))
	...
	if in.MetallbNamespace != nil {
		in, out := &in.MetallbNamespace, &out.MetallbNamespace
		*out = new(string)
		**out = **in
	}
	if in.NotifyExtenal != nil {
...
func (in *MetallbScanStatus) DeepCopyInto(out *MetallbScanStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]MetallbScanCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
